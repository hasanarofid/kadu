...
<template>
  <div class="h-screen h-dvh max-h-screen overflow-hidden relative font-sans antialiased text-[#5c2c24] bg-[#f8efdf] selection:bg-[#e98318] selection:text-white flex flex-col justify-between">
    ...
    <div class="relative z-10 grid grid-cols-1 lg:grid-cols-12 h-screen max-h-screen overflow-hidden">
      <!-- Left Hero Section -->
      <div class="hidden lg:block lg:col-span-7 relative h-screen max-h-screen overflow-hidden bg-gradient-to-r from-black/10 to-transparent">
        <div 
        ...
        <!-- Hero Text Content -->
        <div class="absolute bottom-10 left-12 right-12 z-10 text-white space-y-3 max-w-xl">
          <div class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#e98318]/90 border border-[#e09d49]/50 shadow-lg text-[11px] font-extrabold tracking-wider uppercase">
            <span>Syiar Travel Umroh & Haji</span>
          </div>
          <h2 class="text-3xl sm:text-4xl font-black tracking-tight leading-tight drop-shadow-md">
            Wujudkan Niat Suci Beribadah ke Tanah Haram
          </h2>
          <p class="text-xs sm:text-sm font-medium text-slate-200 leading-relaxed drop-shadow">
          ...
          <div class="pt-2 flex items-center gap-6 text-xs text-slate-300">
      ...
      <!-- Right Form Section -->
      <div class="col-span-1 lg:col-span-5 relative flex items-center justify-center p-3 sm:p-6 h-screen max-h-screen overflow-hidden">
